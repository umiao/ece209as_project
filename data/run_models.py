...
class LoadValTestDataset(LoadDataset):
    ...
    def __getitem__(self, idx):
        if self.model_type in ['BRITS', 'MRNN']:
...
if __name__ == '__main__':
    config_path = r'/content/drive/MyDrive/209/configs/PhysioNet2012_MRNN_best.ini'
    test_mode = False
    ...
    if args.model_type in ['BRITS', 'MRNN']:  # if RNN-based model
        if args.model_type == 'BRITS':
